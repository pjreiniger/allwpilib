...
struct is_compatible_string_type_impl <
    ...
    enable_if_t<is_detected_exact<std::string::value_type,
...
struct has_from_json<BasicJsonType, T,
           enable_if_t<not is_json<T>::value>>
{
...
template<typename BasicJsonType, typename T>
struct has_non_default_from_json<BasicJsonType, T, enable_if_t<not is_json<T>::value>>
{
    using serializer = typename BasicJsonType::template json_serializer<T, void>;
...
// Do not evaluate the trait when T is a json type, to avoid template instantiation infinite recursion.
template <typename BasicJsonType, typename T, typename = void>
struct has_to_json : std::false_type {};

template <typename BasicJsonType, typename T>
struct has_to_json<BasicJsonType, T, enable_if_t<not is_json<T>::value>>
{
    using serializer = typename BasicJsonType::template json_serializer<T, void>;
