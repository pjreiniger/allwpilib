...
using wpi::ordered_json;
using json_ptr_str = wpi::json_pointer<std::string>;
using json_ptr_j = wpi::json_pointer<json>;
using json_ptr_oj = wpi::json_pointer<ordered_json>;





TEST(JSONPointersErrorsTest, BasicTest)
{
...
TEST(JSONPointersErrorsTest, ArrayIndexError)
{
    json v = {1, 2, 3, 4};
...
TEST(JSONPointersExamplesFromRFC6901Test, NonconstAccess)
{
    json j = R"(
    {
        "foo": ["bar", "baz"],
...
TEST(JSONPointersExamplesFromRFC6901Test, ConstAccess)
{
    const json j = R"(
    {
        "foo": ["bar", "baz"],
...
TEST(JSONPointersExamplesFromRFC6901Test, UserDefinedStringLiteral)
{
    json j = R"(
    {
        "foo": ["bar", "baz"],
...
TEST(JSONPointersArrayAccessTest, NonconstAccess)
{
    json j = {1, 2, 3};
...
TEST(JSONPointersArrayAccessTest, ConstAccess)
{
    const json j = {1, 2, 3};
...
TEST(JSONPointersTest, StringRepresentation)
{
...
TEST(JSONPointersConversionTest, Array)
{
    json j;
    // all numbers -> array
...
TEST(JSONPointersConversionTest, Object)
{
    json j;
...
TEST(JSONPointersTest, EmptyPushPopAndParent)
{
    const json j =
    {
        {"", "Hello"},
...
TEST(JSONPointersTest, Operators)
{
    const json j =
    {
        {"", "Hello"},
...
class JSONPointersEqualityComparisonTest : public ::testing::Test {
 protected:
    ...
    json::json_pointer ptr1 = json::json_pointer(ptr_string);
    json::json_pointer ptr2 = json::json_pointer(ptr_string);
...
TEST_F(JSONPointersEqualityComparisonTest, BasicTest)
{
    CHECK(ptr1 == ptr2);
...
TEST_F(JSONPointersEqualityComparisonTest, Exceptions)
{
...
TEST(JSONPointersTest, LessThanComparison)
{
...
TEST(JSONPointersTest, UsableAsMapKey)
{
...
class JSONPointersBackwardsCompatibilityAndMixingTest : public ::testing::Test {
 protected:
    json j = R"(
    {
        "foo": ["bar", "baz"]
...
TEST_F(JSONPointersBackwardsCompatibilityAndMixingTest, EqualityComparison)
{
    // build with C++20 to test rewritten candidates
    // JSON_HAS_CPP_20
