...
TEST(UBJSONIndividualValuesTest, Discarded)
{
...
TEST(UBJSONIndividualValuesTest, Null)
{
    json j = nullptr;
...
TEST(UBJSONIndividualValuesBooleanTest, True)
{
    json j = true;
...
TEST(UBJSONIndividualValuesBooleanTest, False)
{
    json j = false;
...
TEST(UBJSONIndividualValuesNumberSignedTest, Neg0)
{
...
TEST(UBJSONIndividualValuesNumberSignedTest, Neg1)
{
...
TEST(UBJSONIndividualValuesNumberSignedTest, Neg2)
{
...
TEST(UBJSONIndividualValuesNumberSignedTest, Neg3)
{
    json j = -9263;
...
TEST(UBJSONIndividualValuesNumberSignedTest, Neg4)
{
...
TEST(UBJSONIndividualValuesNumberSignedTest, Pos0)
{
...
TEST(UBJSONIndividualValuesNumberSignedTest, Pos1)
{
...
TEST(UBJSONIndividualValuesNumberSignedTest, Pos2)
{
...
TEST(UBJSONIndividualValuesNumberSignedTest, Pos3)
{
    for (uint32_t i :
            {
...
TEST(UBJSONIndividualValuesNumberSignedTest, Pos4)
{
...
TEST(UBJSONIndividualValuesNumberUnsignedTest, Pos0)
{
    for (size_t i = 0; i <= 127; ++i)
    {
        CAPTURE(i)
...
TEST(UBJSONIndividualValuesNumberUnsignedTest, Pos1)
{
    for (size_t i = 128; i <= 255; ++i)
    {
        CAPTURE(i)
...
TEST(UBJSONIndividualValuesNumberUnsignedTest, Pos2)
{
    for (size_t i = 256; i <= 32767; ++i)
    {
        CAPTURE(i)
...
TEST(UBJSONIndividualValuesNumberUnsignedTest, Pos3)
{
    for (uint32_t i :
            {
                65536u, 77777u, 1048576u
...
TEST(UBJSONIndividualValuesNumberUnsignedTest, Pos4)
{
    std::vector<uint64_t> v = {2147483648ul, 9223372036854775807ul};
    for (uint64_t i : v)
    {
...
TEST(UBJSONIndividualValuesNumberFloat64Test, Pi)
{
    double v = 3.1415925;
    json j = v;
    std::vector<uint8_t> expected =
...
TEST(UBJSONIndividualValuesNumberHighPrecisionNumberTest, UnsignedIntegerNumber)
{
...
TEST(UBJSONIndividualValuesNumberHighPrecisionNumberTest, SignedIntegerNumber)
{
...
TEST(UBJSONIndividualValuesNumberHighPrecisionNumberTest, FloatingPointNumber)
{
...
TEST(UBJSONIndividualValuesNumberHighPrecisionNumberTest, Errors)
{
...
TEST(UBJSONIndividualValuesNumberHighPrecisionNumberTest, Serialization)
{
...
TEST(UBJSONIndividualValuesStringTest, String1)
{
...
TEST(UBJSONIndividualValuesStringTest, String2)
{
...
TEST(UBJSONIndividualValuesStringTest, String3)
{
    for (size_t N :
            {
...
TEST(UBJSONIndividualValuesStringTest, String4)
{
    for (size_t N :
            {
                65536u, 77777u, 1048576u
...
TEST(UBJSONIndividualValuesBinaryTest, String1)
{
...
TEST(UBJSONIndividualValuesBinaryTest, String2)
{
...
TEST(UBJSONIndividualValuesBinaryTest, String3)
{
    for (std::size_t N :
            {
                256u, 999u, 1025u, 3333u, 2048u, 32767u
...
TEST(UBJSONIndividualValuesBinaryTest, N327682147483647)
{
    for (std::size_t N :
            {
...
class UBJSONIndividualValuesBinaryOtherSerializationsTest : public ::testing::Test {
 protected:
    UBJSONIndividualValuesBinaryOtherSerializationsTest() : s(N, 'x'), j(json::binary(s)) {}
...
TEST_F(UBJSONIndividualValuesBinaryOtherSerializationsTest, NoCountNoType)
{
    std::vector<uint8_t> expected;
    expected.push_back(static_cast<std::uint8_t>('['));
...
TEST_F(UBJSONIndividualValuesBinaryOtherSerializationsTest, YesCountNoType)
{
    std::vector<std::uint8_t> expected;
    expected.push_back(static_cast<std::uint8_t>('['));
    expected.push_back(static_cast<std::uint8_t>('#'));
...
TEST(UBJSONIndividualValuesArrayEmptyTest, SizeFalseTypeFalse)
{
    json j = json::array();
    std::vector<uint8_t> expected = {'[', ']'};
    const auto result = json::to_ubjson(j);
...
TEST(UBJSONIndividualValuesArrayEmptyTest, SizeTrueTypeFalse)
{
    json j = json::array();
...
TEST(UBJSONIndividualValuesArrayEmptyTest, SizeTrueTypeTrue)
{
    json j = json::array();
    std::vector<uint8_t> expected = {'[', '#', 'i', 0};
    const auto result = json::to_ubjson(j, true, true);
...
TEST(UBJSONIndividualValuesArrayNullTest, SizeFalseTypeFalse)
{
    json j = {nullptr};
    std::vector<uint8_t> expected = {'[', 'Z', ']'};
    const auto result = json::to_ubjson(j);
...
TEST(UBJSONIndividualValuesArrayNullTest, SizeTrueTypeFalse)
{
    json j = {nullptr};
...
TEST(UBJSONIndividualValuesArrayNullTest, SizeTrueTypeTrue)
{
    json j = {nullptr};
...
TEST(UBJSONIndividualValuesArraySimpleTest, SizeFalseTypeFalse)
{
...
TEST(UBJSONIndividualValuesArraySimpleTest, SizeTrueTypeFalse)
{
    json j = json::parse("[1,2,3,4,5]");
...
TEST(UBJSONIndividualValuesArraySimpleTest, SizeTrueTypeTrue)
{
    json j = json::parse("[1,2,3,4,5]");
...
TEST(UBJSONIndividualValuesArrayNestedEmptyTest, SizeFalseTypeFalse)
{
    json j = json::parse("[[[[]]]]");
    std::vector<uint8_t> expected = {'[', '[', '[', '[', ']', ']', ']', ']'};
    const auto result = json::to_ubjson(j);
...
TEST(UBJSONIndividualValuesArrayNestedEmptyTest, SizeTrueTypeFalse)
{
    json j = json::parse("[[[[]]]]");
...
TEST(UBJSONIndividualValuesArrayNestedEmptyTest, SizeTrueTypeTrue)
{
    json j = json::parse("[[[[]]]]");
    std::vector<uint8_t> expected = {'[', '$', '[', '#', 'i', 1, '$', '[', '#', 'i', 1, '$', '[', '#', 'i', 1, '#', 'i', 0};
    const auto result = json::to_ubjson(j, true, true);
...
TEST(UBJSONIndividualValuesArrayArrayWithUint16ElementsTest, SizeFalseTypeFalse)
{
    json j(257, nullptr);
...
TEST(UBJSONIndividualValuesArrayArrayWithUint16ElementsTest, SizeTrueTypeFalse)
{
    json j(257, nullptr);
...
TEST(UBJSONIndividualValuesArrayArrayWithUint16ElementsTest, SizeTrueTypeTrue)
{
    json j(257, nullptr);
...
TEST(UBJSONIndividualValuesArrayArrayWithUint32ElementsTest, SizeFalseTypeFalse)
{
...
TEST(UBJSONIndividualValuesArrayArrayWithUint32ElementsTest, SizeTrueTypeFalse)
{
    json j(65793, nullptr);
...
TEST(UBJSONIndividualValuesArrayArrayWithUint32ElementsTest, SizeTrueTypeTrue)
{
    json j(65793, nullptr);
...
TEST(UBJSONIndividualValuesObjectEmptyTest, SizeFalseTypeFalse)
{
    json j = json::object();
    std::vector<uint8_t> expected = {'{', '}'};
    const auto result = json::to_ubjson(j);
...
TEST(UBJSONIndividualValuesObjectEmptyTest, SizeTrueTypeFalse)
{
    json j = json::object();
    std::vector<uint8_t> expected = {'{', '#', 'i', 0};
    const auto result = json::to_ubjson(j, true);
...
TEST(UBJSONIndividualValuesObjectEmptyTest, SizeTrueTypeTrue)
{
    json j = json::object();
    std::vector<uint8_t> expected = {'{', '#', 'i', 0};
    const auto result = json::to_ubjson(j, true, true);
...
TEST(UBJSONIndividualValuesObjectEmptyKeyTest, SizeFalseTypeFalse)
{
    json j = {{"", nullptr}};
...
TEST(UBJSONIndividualValuesObjectEmptyKeyTest, SizeTrueTypeFalse)
{
    json j = {{"", nullptr}};
...
TEST(UBJSONIndividualValuesObjectEmptyKeyTest, SizeTrueTypeTrue)
{
    json j = {{"", nullptr}};
...
TEST(UBJSONIndividualValuesObjectNestedEmptyTest, SizeFalseTypeFalse)
{
...
TEST(UBJSONIndividualValuesObjectNestedEmptyTest, SizeTrueTypeFalse)
{
    json j = json::parse(R"({"a": {"b": {"c": {}}}})");
    std::vector<uint8_t> expected =
    {
...
TEST(UBJSONIndividualValuesObjectNestedEmptyTest, SizeTrueTypeTrue)
{
    json j = json::parse(R"({"a": {"b": {"c": {}}}})");
    std::vector<uint8_t> expected =
    {
...
class UBJSONErrorsStrictModeTest : public ::testing::Test {
 protected:
    std::vector<uint8_t> vec = {'Z', 'Z'};
};


TEST_F(UBJSONErrorsStrictModeTest, NonStrictMode)
{
    const auto result = json::from_ubjson(vec, false);
    CHECK(result == json());
}

TEST_F(UBJSONErrorsStrictModeTest, StrictMode)
{
    json _;
...
TEST(UBJSONErrorsExcessiveSizeTest, Array)
{
    ...
    json j;
    wpi::detail::json_sax_dom_callback_parser<json> scp(j, [](int /*unused*/, json::parse_event_t /*unused*/, const json& /*unused*/) noexcept
    {
        return true;
    });
...
TEST(UBJSONErrorsExcessiveSizeTest, Object)
{
    std::vector<uint8_t> v_ubjson = {'{', '$', 'Z', '#', 'L', 0x78, 0x28, 0x00, 0x68, 0x28, 0x69, 0x69, 0x17};
    json _;
    CHECK_THROWS_AS(_ = json::from_ubjson(v_ubjson), json::out_of_range&);
...
TEST(UBJSONSAXAbortsTest, StartArray)
{
...
TEST(UBJSONSAXAbortsTest, StartObject)
{
...
TEST(UBJSONSAXAbortsTest, KeyInObject)
{
    std::vector<uint8_t> v = {'{', 'i', 3, 'f', 'o', 'o', 'F', '}'};
    SaxCountdown scp(1);
    CHECK(!json::sax_parse(v, &scp, json::input_format_t::ubjson));
...
TEST(UBJSONSAXAbortsTest, StartArrayLen)
{
...
TEST(UBJSONSAXAbortsTest, StartObjectLen)
{
...
TEST(UBJSONSAXAbortsTest, KeyInObjectWithLength)
{
    std::vector<uint8_t> v = {'{', 'i', 3, 'f', 'o', 'o', 'F', '}'};
    SaxCountdown scp(1);
    CHECK(!json::sax_parse(v, &scp, json::input_format_t::ubjson));
...
TEST(UBJSONParsingValuesTest, Strings)
{
...
TEST(UBJSONParsingValuesNumberTest, Float)
{
    // float32
...
TEST(UBJSONParsingValuesArrayTest, OptimizedVersionLengthOnly)
{
...
TEST(UBJSONParsingValuesArrayTest, OptimizedVersionTypeAndLength)
{
    // create vector with two elements of the same type
...
TEST(UBJSONParseErrorsTest, EmptyByteVector)
{
    json _;
...
TEST(UBJSONParseErrorsCharTest, EofAfterCByte)
{
...
TEST(UBJSONParseErrorsCharTest, ByteOutOfRange)
{
...
TEST(UBJSONParseErrorsStringsTest, EofAfterSByte)
{
...
TEST(UBJSONParseErrorsStringsTest, InvalidByte)
{
...
TEST(UBJSONParseErrorsArrayTest, OptimizedArrayNoSizeFollowingType)
{
...
TEST(UBJSONParseErrorsTest, Strings)
{
...
TEST(UBJSONParseErrorsTest, Sizes)
{
...
TEST(UBJSONParseErrorsTest, Types)
{
...
TEST(UBJSONParseErrorsTest, Arrays)
{
...
TEST(UBJSONParseErrorsTest, Objects)
{
...
TEST(UBJSONWritingOptimizedValuesIntegerTest, ArrayOfI)
{
    json j = {1, -1};
...
TEST(UBJSONWritingOptimizedValuesIntegerTest, ArrayOfU)
{
    json j = {200, 201};
...
TEST(UBJSONWritingOptimizedValuesIntegerTest, ArrayOfI2)
{
    json j = {30000, -30000};
...
TEST(UBJSONWritingOptimizedValuesIntegerTest, ArrayOfL)
{
    json j = {70000, -70000};
...
TEST(UBJSONWritingOptimizedValuesIntegerTest, ArrayOfL2)
{
...
TEST(UBJSONWritingOptimizedValuesUnsignedIntegerTest, ArrayOfI)
{
    json j = {1u, 2u};
...
TEST(UBJSONWritingOptimizedValuesUnsignedIntegerTest, ArrayOfU)
{
    json j = {200u, 201u};
    std::vector<uint8_t> expected = {'[', '$', 'U', '#', 'i', 2, 0xC8, 0xC9};
...
TEST(UBJSONWritingOptimizedValuesUnsignedIntegerTest, ArrayOfI2)
{
...
TEST(UBJSONWritingOptimizedValuesUnsignedIntegerTest, ArrayOfL)
{
...
TEST(UBJSONWritingOptimizedValuesUnsignedIntegerTest, ArrayOfL2)
{
...
TEST(UBJSONWritingOptimizedValuesTest, Discarded)
{
