...
TEST(ConceptsTest, ContainerRequirementsForJson)
{
...
TEST(ConceptsClassIteratorTest, CopyConstructible)
{
...
TEST(ConceptsClassIteratorTest, CopyAssignable)
{
