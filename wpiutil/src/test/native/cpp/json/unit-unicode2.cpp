...
TEST(Unicode25RFC3629Test, IllFormedFirstByte)
{
...
TEST(Unicode25RFC3629UTF81X00X7FTest, DISABLED_WellFormed)
{
...
TEST(Unicode25RFC3629UTF82XC2XDFUTF8TailTest, DISABLED_WellFormed)
{
...
TEST(Unicode25RFC3629UTF82XC2XDFUTF8TailTest, IllFormedMissingSecondByte)
{
    for (int byte1 = 0xC2; byte1 <= 0xDF; ++byte1)
    {
        check_utf8string(false, byte1);
...
TEST(Unicode25RFC3629UTF82XC2XDFUTF8TailTest, DISABLED_IllFormedWrongSecondByte)
{
    for (int byte1 = 0xC2; byte1 <= 0xDF; ++byte1)
    {
...
TEST(Unicode25RFC3629UTF83XE0XA0BFUTF8TailTest, DISABLED_WellFormed)
{
...
TEST(Unicode25RFC3629UTF83XE0XA0BFUTF8TailTest, IllFormedMissingSecondByte)
{
    for (int byte1 = 0xE0; byte1 <= 0xE0; ++byte1)
    {
        check_utf8string(false, byte1);
...
TEST(Unicode25RFC3629UTF83XE0XA0BFUTF8TailTest, DISABLED_IllFormedMissingThirdByte)
{
    for (int byte1 = 0xE0; byte1 <= 0xE0; ++byte1)
    {
        for (int byte2 = 0xA0; byte2 <= 0xBF; ++byte2)
...
TEST(Unicode25RFC3629UTF83XE0XA0BFUTF8TailTest, DISABLED_IllFormedWrongSecondByte)
{
    for (int byte1 = 0xE0; byte1 <= 0xE0; ++byte1)
    {
        for (int byte2 = 0x00; byte2 <= 0xFF; ++byte2)
...
TEST(Unicode25RFC3629UTF83XE0XA0BFUTF8TailTest, DISABLED_IllFormedWrongThirdByte)
{
    for (int byte1 = 0xE0; byte1 <= 0xE0; ++byte1)
    {
        for (int byte2 = 0xA0; byte2 <= 0xBF; ++byte2)
...
TEST(Unicode25RFC3629UTF83XE1XECUTF8TailUTF8TailTest, DISABLED_WellFormed)
{
...
TEST(Unicode25RFC3629UTF83XE1XECUTF8TailUTF8TailTest, IllFormedMissingSecondByte)
{
    for (int byte1 = 0xE1; byte1 <= 0xEC; ++byte1)
    {
        check_utf8string(false, byte1);
...
TEST(Unicode25RFC3629UTF83XE1XECUTF8TailUTF8TailTest, DISABLED_IllFormedMissingThirdByte)
{
    for (int byte1 = 0xE1; byte1 <= 0xEC; ++byte1)
    {
        for (int byte2 = 0x80; byte2 <= 0xBF; ++byte2)
...
TEST(Unicode25RFC3629UTF83XE1XECUTF8TailUTF8TailTest, DISABLED_IllFormedWrongSecondByte)
{
    for (int byte1 = 0xE1; byte1 <= 0xEC; ++byte1)
    {
        for (int byte2 = 0x00; byte2 <= 0xFF; ++byte2)
...
TEST(Unicode25RFC3629UTF83XE1XECUTF8TailUTF8TailTest, DISABLED_IllFormedWrongThirdByte)
{
    for (int byte1 = 0xE1; byte1 <= 0xEC; ++byte1)
    {
        for (int byte2 = 0x80; byte2 <= 0xBF; ++byte2)
...
TEST(Unicode25RFC3629UTF83XEDX809FUTF8TailTest, DISABLED_WellFormed)
{
...
TEST(Unicode25RFC3629UTF83XEDX809FUTF8TailTest, DISABLED_IllFormedMissingSecondByte)
{
    for (int byte1 = 0xED; byte1 <= 0xED; ++byte1)
    {
        check_utf8string(false, byte1);
...
TEST(Unicode25RFC3629UTF83XEDX809FUTF8TailTest, DISABLED_IllFormedMissingThirdByte)
{
    for (int byte1 = 0xED; byte1 <= 0xED; ++byte1)
    {
        for (int byte2 = 0x80; byte2 <= 0x9F; ++byte2)
...
TEST(Unicode25RFC3629UTF83XEDX809FUTF8TailTest, DISABLED_IllFormedWrongSecondByte)
{
    for (int byte1 = 0xED; byte1 <= 0xED; ++byte1)
    {
        for (int byte2 = 0x00; byte2 <= 0xFF; ++byte2)
...
TEST(Unicode25RFC3629UTF83XEDX809FUTF8TailTest, DISABLED_IllFormedWrongThirdByte)
{
    for (int byte1 = 0xED; byte1 <= 0xED; ++byte1)
    {
        for (int byte2 = 0x80; byte2 <= 0x9F; ++byte2)
...
TEST(Unicode25RFC3629UTF83XEEXEFUTF8TailUTF8TailTest, DISABLED_WellFormed)
{
...
TEST(Unicode25RFC3629UTF83XEEXEFUTF8TailUTF8TailTest, IllFormedMissingSecondByte)
{
    for (int byte1 = 0xEE; byte1 <= 0xEF; ++byte1)
    {
        check_utf8string(false, byte1);
...
TEST(Unicode25RFC3629UTF83XEEXEFUTF8TailUTF8TailTest, DISABLED_IllFormedMissingThirdByte)
{
    for (int byte1 = 0xEE; byte1 <= 0xEF; ++byte1)
    {
        for (int byte2 = 0x80; byte2 <= 0xBF; ++byte2)
...
TEST(Unicode25RFC3629UTF83XEEXEFUTF8TailUTF8TailTest, DISABLED_IllFormedWrongSecondByte)
{
    for (int byte1 = 0xEE; byte1 <= 0xEF; ++byte1)
    {
        for (int byte2 = 0x00; byte2 <= 0xFF; ++byte2)
...
TEST(Unicode25RFC3629UTF83XEEXEFUTF8TailUTF8TailTest, DISABLED_IllFormedWrongThirdByte)
{
    for (int byte1 = 0xEE; byte1 <= 0xEF; ++byte1)
    {
        for (int byte2 = 0x80; byte2 <= 0xBF; ++byte2)
