...
TEST(Unicode45RFC3629UTF84XF1F3UTF8TailUTF8TailUTF8TailTest, DISABLED_WellFormed)
{
...
TEST(Unicode45RFC3629UTF84XF1F3UTF8TailUTF8TailUTF8TailTest, IllFormedMissingSecondByte)
{
    for (int byte1 = 0xF1; byte1 <= 0xF3; ++byte1)
    {
...
TEST(Unicode45RFC3629UTF84XF1F3UTF8TailUTF8TailUTF8TailTest, DISABLED_IllFormedMissingThirdByte)
{
    for (int byte1 = 0xF1; byte1 <= 0xF3; ++byte1)
    {
        for (int byte2 = 0x80; byte2 <= 0xBF; ++byte2)
...
TEST(Unicode45RFC3629UTF84XF1F3UTF8TailUTF8TailUTF8TailTest, DISABLED_IllFormedMissingFourthByte)
{
    for (int byte1 = 0xF1; byte1 <= 0xF3; ++byte1)
    {
        for (int byte2 = 0x80; byte2 <= 0xBF; ++byte2)
...
TEST(Unicode45RFC3629UTF84XF1F3UTF8TailUTF8TailUTF8TailTest, DISABLED_IllFormedWrongSecondByte)
{
    for (int byte1 = 0xF1; byte1 <= 0xF3; ++byte1)
    {
...
TEST(Unicode45RFC3629UTF84XF1F3UTF8TailUTF8TailUTF8TailTest, DISABLED_IllFormedWrongThirdByte)
{
    for (int byte1 = 0xF1; byte1 <= 0xF3; ++byte1)
    {
        for (int byte2 = 0x80; byte2 <= 0xBF; ++byte2)
...
TEST(Unicode45RFC3629UTF84XF1F3UTF8TailUTF8TailUTF8TailTest, DISABLED_IllFormedWrongFourthByte)
{
    for (int byte1 = 0xF1; byte1 <= 0xF3; ++byte1)
    {
        for (int byte2 = 0x80; byte2 <= 0xBF; ++byte2)
