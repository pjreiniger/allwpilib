...
const std::string codepoint_to_unicode(std::size_t cp)
{
...
TEST(Unicode15UxxxxSequencesTest, CorrectSequences)
{
...
TEST(Unicode15UxxxxSequencesIncorrectSequencesTest, IncorrectSurrogateValues)
{
    json _;
...
TEST(Unicode15UxxxxSequencesIncorrectSequencesTest, HighSurrogateWithoutLowSurrogate)
{
...
TEST(Unicode15UxxxxSequencesIncorrectSequencesTest, HighSurrogateWithWrongLowSurrogate)
{
    // D800..DBFF are high surrogates and must be followed by low
...
TEST(Unicode15UxxxxSequencesIncorrectSequencesTest, LowSurrogateWithoutHighSurrogate)
{
...
TEST(Unicode15IgnoreByteOrderMarkTest, WithAnIterator)
{
...
TEST(Unicode15Test, ErrorForIncompleteWrongBOM)
{
    json _;
...
TEST(MarkusKuhnsUTF8DecoderCapabilityAndStressTestTest, 1SomeCorrectUTF8Text)
{
...
TEST(MarkusKuhnsUTF8DecoderCapabilityAndStressTest2BoundaryConditionTestCasesTest, 21FirstPossibleSequenceOfACertainLength)
{
...
TEST(MarkusKuhnsUTF8DecoderCapabilityAndStressTest2BoundaryConditionTestCasesTest, 22LastPossibleSequenceOfACertainLength)
{
...
TEST(MarkusKuhnsUTF8DecoderCapabilityAndStressTest2BoundaryConditionTestCasesTest, 23OtherBoundaryConditions)
{
...
TEST(MarkusKuhnsUTF8DecoderCapabilityAndStressTest3MalformedSequencesTest, 31UnexpectedContinuationBytes)
{
...
TEST(MarkusKuhnsUTF8DecoderCapabilityAndStressTest3MalformedSequencesTest, 32LonelyStartCharacters)
{
...
TEST(MarkusKuhnsUTF8DecoderCapabilityAndStressTest3MalformedSequencesTest, 33SequencesWithLastContinuationByteMissing)
{
...
TEST(MarkusKuhnsUTF8DecoderCapabilityAndStressTest3MalformedSequencesTest, 34ConcatenationOfIncompleteSequences)
{
...
TEST(MarkusKuhnsUTF8DecoderCapabilityAndStressTest3MalformedSequencesTest, 35ImpossibleBytes)
{
...
TEST(MarkusKuhnsUTF8DecoderCapabilityAndStressTest4OverlongSequencesTest, 41ExamplesOfAnOverlongASCIICharacter)
{
...
TEST(MarkusKuhnsUTF8DecoderCapabilityAndStressTest4OverlongSequencesTest, 42MaximumOverlongSequences)
{
...
TEST(MarkusKuhnsUTF8DecoderCapabilityAndStressTest4OverlongSequencesTest, 43OverlongRepresentationOfTheNULCharacter)
{
...
TEST(MarkusKuhnsUTF8DecoderCapabilityAndStressTest5IllegalCodePositionsTest, 51SingleUTF16Surrogates)
{
...
TEST(MarkusKuhnsUTF8DecoderCapabilityAndStressTest5IllegalCodePositionsTest, 52PairedUTF16Surrogates)
{
...
TEST(MarkusKuhnsUTF8DecoderCapabilityAndStressTest5IllegalCodePositionsTest, 53NoncharacterCodePositions)
{
