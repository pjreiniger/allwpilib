...
TEST(BSONIndividualValuesNotSupportedTest, Null)
{
    json j = nullptr;
...
TEST(BSONIndividualValuesNotSupportedBooleanTest, True)
{
    json j = true;
...
TEST(BSONIndividualValuesNotSupportedBooleanTest, False)
{
    json j = false;
    CHECK_THROWS_WITH_AS(json::to_bson(j), "[json.exception.type_error.317] to serialize to BSON, top-level type must be object, but is boolean", json::type_error&);
}

TEST(BSONIndividualValuesNotSupportedTest, Number)
{
    json j = 42;
...
TEST(BSONIndividualValuesNotSupportedTest, Float)
{
    json j = 4.2;
    CHECK_THROWS_WITH_AS(json::to_bson(j), "[json.exception.type_error.317] to serialize to BSON, top-level type must be object, but is number", json::type_error&);
}

TEST(BSONIndividualValuesNotSupportedTest, String)
{
...
TEST(BSONIndividualValuesNotSupportedTest, Array)
{
...
TEST(BSONTest, KeysContainingCodePointU0000CannotBeSerializedToBSON)
{
    json j =
    {
...
TEST(BSONTest, StringLengthMustBeAtLeast1)
{
...
TEST(BSONObjectsTest, EmptyObject)
{
    json j = json::object();
...
TEST(BSONObjectsTest, NonEmptyObjectWithBool)
{
    json j =
    {
        { "entry", true }
...
TEST(BSONObjectsTest, NonEmptyObjectWithBool2)
{
    json j =
    {
        { "entry", false }
...
TEST(BSONObjectsTest, NonEmptyObjectWithDouble)
{
    json j =
    {
        { "entry", 4.2 }
...
TEST(BSONObjectsTest, NonEmptyObjectWithString)
{
    json j =
    {
        { "entry", "bsonstr" }
...
TEST(BSONObjectsTest, NonEmptyObjectWithNullMember)
{
    json j =
    {
        { "entry", nullptr }
...
TEST(BSONObjectsTest, NonEmptyObjectWithInteger32BitMember)
{
    json j =
    {
...
TEST(BSONObjectsTest, NonEmptyObjectWithInteger64BitMember)
{
    json j =
    {
...
TEST(BSONObjectsTest, NonEmptyObjectWithNegativeInteger32BitMember)
{
    json j =
    {
        { "entry", std::int32_t{-1} }
...
TEST(BSONObjectsTest, NonEmptyObjectWithNegativeInteger64BitMember)
{
    json j =
    {
        { "entry", std::int64_t{-1} }
...
TEST(BSONObjectsTest, NonEmptyObjectWithUnsignedInteger64BitMember)
{
...
TEST(BSONObjectsTest, NonEmptyObjectWithSmallUnsignedIntegerMember)
{
    json j =
    {
...
TEST(BSONObjectsTest, NonEmptyObjectWithObjectMember)
{
    json j =
    {
        { "entry", json::object() }
...
TEST(BSONObjectsTest, NonEmptyObjectWithArrayMember)
{
    json j =
    {
        { "entry", json::array() }
...
TEST(BSONObjectsTest, NonEmptyObjectWithNonEmptyArrayMember)
{
    json j =
    {
...
TEST(BSONObjectsTest, NonEmptyObjectWithBinaryMember)
{
    const size_t N = 10;
...
TEST(BSONObjectsTest, NonEmptyObjectWithBinaryMemberWithSubtype)
{
    // an MD5 hash
...
TEST(BSONObjectsTest, SomeMoreComplexDocument)
{
    // directly encoding uint64 is not supported in bson (only for timestamp values)
    json j =
    {
...
TEST(BSONExamplesFromHttpBsonspecOrgFaqHtmlTest, Example1)
{
...
TEST(BSONExamplesFromHttpBsonspecOrgFaqHtmlTest, Example2)
{
...
class BSONInputOutputAdaptersTest : public ::testing::Test {
 protected:
...
TEST_F(BSONInputOutputAdaptersTest, BasicTest)
{
json j2;
...
class BSONInputOutputAdaptersRoundtripsTest : public BSONInputOutputAdaptersTest{};


TEST_F(BSONInputOutputAdaptersRoundtripsTest, StdOstringstream)
{
...
TEST_F(BSONInputOutputAdaptersRoundtripsTest, StdString)
{
    std::string s;
...
TEST_F(BSONInputOutputAdaptersRoundtripsTest, StdVector)
{
    std::vector<std::uint8_t> v;
...
TEST(IncompleteBSONInputTest, IncompleteBSONInput1)
{
...
TEST(IncompleteBSONInputTest, IncompleteBSONInput2)
{
    std::vector<std::uint8_t> incomplete_bson =
    {
        0x0D, 0x00, 0x00, 0x00, // size (little endian)
...
TEST(IncompleteBSONInputTest, IncompleteBSONInput3)
{
    std::vector<std::uint8_t> incomplete_bson =
    {
...
TEST(IncompleteBSONInputTest, IncompleteBSONInput4)
{
    std::vector<std::uint8_t> incomplete_bson =
    {
...
TEST(IncompleteBSONInputImproveCoverageTest, Key)
{
    json j = {{"key", "value"}};
...
TEST(IncompleteBSONInputImproveCoverageTest, Array)
{
    json j =
    {
        { "entry", json::array() }
...
TEST(Test, NegativeSizeOfBinaryValue)
{
...
TEST(Test, UnsupportedBSONInput)
{
...
TEST(BSONNumericalDataNumberSignedTest, StdInt64INT64MININT32MIN1)
{
...
TEST(BSONNumericalDataNumberSignedTest, SignedStdInt32INT32MININT32MAX)
{
...
TEST(BSONNumericalDataNumberSignedTest, SignedStdInt64INT32MAX1INT64MAX)
{
    std::vector<int64_t> numbers
    {
        INT64_MAX,
...
TEST(BSONNumericalDataNumberUnsignedTest, UnsignedStdUint640INT32MAX)
{
...
TEST(BSONNumericalDataNumberUnsignedTest, UnsignedStdUint64INT32MAX1INT64MAX)
{
    std::vector<std::uint64_t> numbers
    {
...
TEST(BSONNumericalDataNumberUnsignedTest, UnsignedStdUint64INT64MAX1UINT64MAX)
{
    std::vector<std::uint64_t> numbers
    {
