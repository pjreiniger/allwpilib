...
{
    auto ia = wpi::detail::input_adapter(s);
    return wpi::detail::lexer<json, decltype(ia)>(std::move(ia), ignore_comments).scan(); // NOLINT(hicpp-move-const-arg,performance-move-const-arg)
}
} // namespace
...
{
    auto ia = wpi::detail::input_adapter(s);
    auto lexer = wpi::detail::lexer<json, decltype(ia)>(std::move(ia), ignore_comments); // NOLINT(hicpp-move-const-arg,performance-move-const-arg)
    lexer.scan();
...
TEST(LexerClassScanTest, StructuralCharacters)
{
...
TEST(LexerClassScanTest, LiteralNames)
{
...
TEST(LexerClassScanTest, Numbers)
{
...
TEST(LexerClassScanTest, Whitespace)
{
...
TEST(LexerClassTest, TokenTypeName)
{
...
TEST(LexerClassTest, ParseErrorsOnFirstCharacter)
{
    for (int c = 1; c < 128; ++c)
    {
...
TEST(LexerClassTest, VeryLargeString)
{
...
TEST(LexerClassTest, FailOnComments)
{
...
TEST(LexerClassTest, IgnoreComments)
{
