...
TEST(Unicode55RFC3629UTF84XF4X808FUTF8TailUTF8TailTest, DISABLED_WellFormed)
{
...
TEST(Unicode55RFC3629UTF84XF4X808FUTF8TailUTF8TailTest, DISABLED_IllFormedMissingSecondByte)
{
    for (int byte1 = 0xF4; byte1 <= 0xF4; ++byte1)
    {
...
TEST(Unicode55RFC3629UTF84XF4X808FUTF8TailUTF8TailTest, DISABLED_IllFormedMissingThirdByte)
{
    for (int byte1 = 0xF4; byte1 <= 0xF4; ++byte1)
    {
        for (int byte2 = 0x80; byte2 <= 0x8F; ++byte2)
...
TEST(Unicode55RFC3629UTF84XF4X808FUTF8TailUTF8TailTest, DISABLED_IllFormedMissingFourthByte)
{
    for (int byte1 = 0xF4; byte1 <= 0xF4; ++byte1)
    {
        for (int byte2 = 0x80; byte2 <= 0x8F; ++byte2)
...
TEST(Unicode55RFC3629UTF84XF4X808FUTF8TailUTF8TailTest, DISABLED_IllFormedWrongSecondByte)
{
    for (int byte1 = 0xF4; byte1 <= 0xF4; ++byte1)
    {
...
TEST(Unicode55RFC3629UTF84XF4X808FUTF8TailUTF8TailTest, DISABLED_IllFormedWrongThirdByte)
{
    for (int byte1 = 0xF4; byte1 <= 0xF4; ++byte1)
    {
        for (int byte2 = 0x80; byte2 <= 0x8F; ++byte2)
...
TEST(Unicode55RFC3629UTF84XF4X808FUTF8TailUTF8TailTest, DISABLED_IllFormedWrongFourthByte)
{
    for (int byte1 = 0xF4; byte1 <= 0xF4; ++byte1)
    {
        for (int byte2 = 0x80; byte2 <= 0x8F; ++byte2)
