...
{
    std::stringstream ss;
    json::serializer s(wpi::detail::output_adapter<char>(ss), ' ');
...
TEST(ConvenienceFunctionsTest, TypeNameAsString)
{
...
TEST(ConvenienceFunctionsTest, StringEscape)
{
    check_escaped("\"", "\\\"");
    check_escaped("\\", "\\\\");
    check_escaped("\b", "\\b");
...
class ConvenienceFunctionsStringConcatTest : public ::testing::Test {
 protected:
...
TEST_F(ConvenienceFunctionsStringConcatTest, StdString)
{
...
TEST_F(ConvenienceFunctionsStringConcatTest, AltStringIter)
{
...
TEST_F(ConvenienceFunctionsStringConcatTest, AltStringData)
{
