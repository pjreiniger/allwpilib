...
frc::ElevatorFeedforward StructType::Unpack(
  ...
  return frc::ElevatorFeedforward{
    ...
    units::unit_t<frc::ElevatorFeedforward::kv_unit>{wpi::UnpackStruct<double, 16>(data)},
    units::unit_t<frc::ElevatorFeedforward::ka_unit>{wpi::UnpackStruct<double, 24>(data)},
  };
}
