...
//     wpi::PackStruct<0>(data, value.Distance());
//     wpi::PackStruct<0>(data, value.Angle());
// }
...
// void wpi::Protobuf<frc::SwerveModulePosition>::Pack(google::protobuf::Message* msg,
//                                              const frc::SwerveModulePosition& value) {
//   auto m = static_cast<wpi::proto::ProtobufSwerveModulePosition*>(msg);
//     m->set_distance_meters(value.Distance());
